...
class AIService:
    ...
    def _build_system_prompt(self, ai_config: dict, rag_context: str, state: dict, discount_context: Optional[dict] = None, sentiment_hint: str = "", product_catalog: str = "", ai_summary: str = "") -> str:
        ...
        if product_catalog:
            catalog_block = (
                "\n[আমাদের পণ্য তালিকা — CRITICAL RULES]\n"
                "⚠️ শুধুমাত্র নিচের তালিকার পণ্য সম্পর্কে কথা বলবে। তালিকায় নেই এমন পণ্য নেই বলো।\n"
                "Customer এমন পণ্য জিজ্ঞেস করলে যা তালিকায় নেই: 'দুঃখিত, [পণ্যের নাম] আমাদের কাছে নেই।' বলো।\n"
                "Gemini general knowledge থেকে কোনো পণ্যের দাম/stock বলবে না — শুধু এই তালিকা।\n\n"
                "--- পণ্য তালিকা ---\n"
                f"{product_catalog}\n"
                "--- তালিকা শেষ ---\n\n"
                "[পণ্য তালিকা দেখানোর নিয়ম — MUST FOLLOW]\n"
                "Customer সব পণ্য বা কোনো category জিজ্ঞেস করলে এই exact format-এ দেখাবে:\n"
                "  🛒 আমাদের পণ্য তালিকা:\n"
                "  [emoji] [category নাম]:\n"
                "    • [পণ্যের নাম] — ৳[দাম]\n"
                "    • [পণ্যের নাম] — ৳[দাম]\n"
                ...
                "  কোনটি নেবেন? 😊\n\n"
                "কঠোর নিয়ম:\n"
                "• SKU code ([SKU:...]) কখনো customer-কে দেখাবে না — শুধু order extract করতে নিজে ব্যবহার করো\n"
                "• প্রতি category-তে উপরের emoji ব্যবহার করো (তালিকায় যে emoji আছে)\n"
                "• একটি category-তে ৫+ পণ্য থাকলে: শুধু প্রথম ৩টি দেখাও + '...আরো X টি আছে, জানতে চান?'\n"
        ...
        return (
            ...
            "- পণ্যের ছবি চাইলে কখনো বলবে না 'আমি ছবি পাঠাতে পারব না' বা 'ছবি দেখাতে অক্ষম'। "
