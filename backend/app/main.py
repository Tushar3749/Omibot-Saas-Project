...
from app.routers import auth, webhook, products, conversations, orders, analytics, channels, payment, campaigns, knowledge, test_bot, combos, stock, returns, complaints, courier, otp, product_images, discount_rules, discounts, notifications, ai_instructions
...
app.include_router(ai_instructions.router, prefix="/api/ai-instructions",  tags=["AIInstructions"])
